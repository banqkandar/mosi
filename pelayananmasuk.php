...
<?php include "navbar.phtml";?>
  ...
  <div class="container">
    <div class="row mt-3">
        <h4>Data Lama Masuk</h4>
        <table class="table table-hover table-dark">
          <tr>
          <?php
              //data .. silahkan pusing sendiri wkwkw
              $i = 1;
              $array = explode("\n", file_get_contents('pelayananmasuk.txt'));
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <table class="table table-hover">
            ...
            <?php 
            $new_line = "\n";
            $file_pointer = './hasilPelMas.txt';
            if(!file_exists($file_pointer)) {
              foreach ($hasil as $data) {
                file_put_contents('hasilPelMas.txt', print_r($data, TRUE), FILE_APPEND); 
                file_put_contents('hasilPelMas.txt', print_r($new_line, TRUE), FILE_APPEND);
              }
            } else {
